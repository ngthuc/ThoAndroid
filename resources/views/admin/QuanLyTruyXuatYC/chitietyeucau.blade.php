        ...
        <div class="col-md-8  col-md-offset-2">
            <form >
                ...
                {{--<div class="col-md-12 form-group input-group">--}}
                    ...
                    {{--<textarea style="width:470px;" class="form-control" rows="4"></textarea>--}}
                {{--</div>--}}

                <div class="col-md-12 text-right">
                    <button type="button" class="btn btn-primary custom-button-width navbar-right" name="xn" style="margin-left:4px;">Xác nhận</button>
                    <a href="{{url('admin/QuanLyTruyXuatYC/xemlichsu')}}"><button type="button" class="btn btn-danger col align-self-center ">Hủy</button></a>
                </div>
