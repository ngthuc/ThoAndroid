...
@section('content')
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">Thêm Loại Yêu Cầu</h3>
            </div>
        </div>
        <center>
            <div class="frame">
                    ...
                    @endif
                        <form action="them" method="POST">
                            ...
                            <div class="form-group input-group">
                                ...
                                <input class="form-control" name="txtten" placeholder="Nhập Loại Yêu Cầu"
                                       required/>
                            </div>
                            <div class="form-group input-group">
                                <span class="input-group-addon" rows="4">Mô tả</span>
                                <textarea class="form-control" rows="4" name="txtmota" placeholder="Nhập Mô tả"
                                          required></textarea>
                            </div>
