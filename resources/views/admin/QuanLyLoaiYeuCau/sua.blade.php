    ...
    <div id="page-wrapper">
        ...
        <div class="frame">
                ...
                @endif
                    ...
                    <form action="{{$requirementtypeModel->UN_ID}}" method="POST">
                        <input type="hidden" name="_token" value="{{csrf_token()}}" />

                        <div class="form-group input-group">
                            <span class="input-group-addon">Tên Loại</span>
                            <input class="form-control" name="txtten" value="{{$requirementtypeModel->RT_NAME}}"/>
                        </div>
                        ...
                        <div class="form-group input-group">
                            ...
                            <textarea class="form-control" rows="4" name="txtmota" placeholder="Nhập mô tả vai trò"
                                      >{{$requirementtypeModel->RT_DESCRIPTION}}</textarea>
                        </div>
